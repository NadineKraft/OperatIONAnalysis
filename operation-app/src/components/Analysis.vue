<template>
  <div class="jumbotron">
    <h1>Select an experiment to start analysis</h1>
        <div v-if="subscriptions && subscriptions.length">
            <div class="card mb-3" v-for="subscription of subscriptions" v-bind:key="subscription.id">
              <div v-if="subscription.processed">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                          ...
                          <p class="card-text">Processed: {{ subscription.processed }}</p>
                            ...
                            <router-link :to="{name: 'start_processing', params: { id: subscription.id }}" class="btn btn-sm btn btn-success">Start processing</router-link>
