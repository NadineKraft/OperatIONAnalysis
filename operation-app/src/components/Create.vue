    ...
    <form @submit.prevent="create" method="post">
      ...
      <div class="form-group">
        ...
        <input
          ...
          :class="{
            'is-invalid':
              errors.has('subscription.input_directory') && submitted
          }"
        />
        <div class="invalid-feedback">
      ...
      <div class="form-group">
        ...
        <input
          ...
          :class="{
            'is-invalid':
              errors.has('subscription.output_directory') && submitted
          }"
        />
        <div class="invalid-feedback">
          Please provide a valid directory.
      ...
      <div class="form-group">
        ...
        <input
          ...
          :class="{
            'is-invalid':
              errors.has('subscription.fasta_reference_directory') && submitted
          }"
        />
        <div class="invalid-feedback">
          Please provide a valid directory.
  ...
  methods: {
    create: function(e) {
      this.$validator.validate().then(result => {
        ...
        axios
          .post("http://127.0.0.1:8000/api/experiments/", this.subscription)
          .then(response => {
